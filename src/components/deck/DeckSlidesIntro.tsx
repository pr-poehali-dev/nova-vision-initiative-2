      ...
      {current === 0 && (
        <div className="h-full grid lg:grid-cols-2 overflow-hidden">
          ...
          <div className="relative overflow-hidden hidden lg:block">
            <img
              src="https://cdn.poehali.dev/projects/d03f091f-8aab-4cf7-98f1-c0c33f947ea5/bucket/0c027611-85ab-416e-b97a-a7e52e4db8bc.jpg"
              alt="Победительница конкурса"
              className="w-full h-full object-cover object-top brightness-[0.88] contrast-[1.05]"
            />
        ...
        <div className="h-full flex flex-col justify-center px-12 lg:px-20 py-10 overflow-y-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
            {[
              ...
              { val: "3 000+", label: "Гостей в зале", desc: "Живая аудитория 19 сентября", color: "border-gold" },
